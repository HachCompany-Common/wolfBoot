...
void hal_tz_sau_init(void)
{
    ...
    /* enable FPU access, secure trampoline code generated by GCC will clear FPU registers */
    SCB_NSACR |= SCB_NSACR_CP10_NS_ALLOWED | SCB_NSACR_CP11_NS_ALLOWED;
    SCB_CPACR |= SCB_CPACR_CP10_FULL_ACCESS | SCB_CPACR_CP11_FULL_ACCESS;     /* set CP10 and CP11 Full Access */
